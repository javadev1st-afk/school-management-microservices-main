...
public class Event {
    ...
    @Column(name = "event_name", nullable = false) private String eventName;
    ...
    @PrePersist void onCreate() { active = active == null || active; createdAt = LocalDateTime.now(); updatedAt = createdAt; }
